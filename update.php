...
if(isset($_POST['update'])){
  ...
  $update_done = $_POST['update_done'];
  $update_query = "UPDATE task_table SET task_name='$update_text', isdone='$update_done' WHERE id=$id";
...
<div class="container" >
  <div class='row'>
    ...
    <input class="form-control form-control-lg" type="text" name="update_done" value="<?=$f_result['isdone'] ?>">
    </div>
    <div class='form-group'>
